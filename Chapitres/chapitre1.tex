...
\label{subsec:contraintes-projet}
...
\textbf{Contraintes organisationnelles.} Le développement est assuré par une seule personne sur une durée fixe de six mois. Cette contrainte de charge a imposé de calibrer le périmètre dès le cadrage : seules les fonctionnalités indispensables au service RI ont été intégrées à l'engagement de livraison, les autres étant explicitement reportées à une version ultérieure ou écartées. Par ailleurs, certaines règles métier, notamment la hiérarchie des quotas, n'étaient pas encore stabilisées au démarrage du projet, et la disponibilité du service RI pour les validations reste limitée aux points d'avancement de fin de sprint.
