...
Ce chapitre présente l'organisme d'accueil et analyse le système d'information utilisé pour la gestion des mobilités internationales. Il en dégage la problématique, positionne le projet par rapport aux solutions existantes, précise les besoins du système et présente la solution envisagée, puis pose le cadrage retenu pour conduire le projet.
...
Côté architecture, la plateforme est organisée en couches : présentation, API, logique métier et données, avec une couche dédiée à l'intégration des imports MoveON, Pégase, Eudonet et Excel. Le choix des technologies pour chaque couche, ainsi que les algorithmes de sélection, d'affectation et de recommandation, sont expliqués au chapitre~\ref{cha:choix-technologiques}. Leur mise en œuvre concrète (organisation du code, modèle de données, machines à états) est détaillée au chapitre~\ref{cha:conception}.
...
\hline
2 & Choix technologiques et algorithmiques (chapitre 2) & 2 semaines \\
\hline
3 & Conception détaillée : product backlog, architecture, modèle de données (chapitre 3) & 2 à 3 semaines \\
\hline
4 & Réalisation itérative en sprints Scrum (chapitre 4) & environ 3 mois \\
\hline
...
Ce chapitre a présenté le contexte du projet, la problématique qui en découle et la solution envisagée, avant de préciser les besoins du système et le cadrage retenu pour le mener à bien. Les choix technologiques et algorithmiques qui permettent de la réaliser font l'objet du chapitre suivant.
