...
Deux options ont été comparées pour répondre à ces besoins.
...
Journalisation et audit & Module d'audit applicatif développé en interne (\texttt{app/audit/ logger.py}) & Traçabilité ciblée des actions administratives via \texttt{log\_action()} \\
\hline
