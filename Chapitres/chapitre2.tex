...
Le chapitre précédent a montré qu'aucune solution existante ne répondait aux besoins du service RI. Ce chapitre précise les besoins du système, puis justifie les technologies retenues pour chaque composant, en comparant les principales alternatives.
...
La seconde catégorie regroupe les tâches planifiées : la synchronisation quotidienne des institutions partenaires (MoveON), ainsi que la suppression automatique des imports bruts anciens. Les synchronisations des données métier (accords, vœux, étudiants, stages) sont déclenchées à la demande depuis l'interface d'administration.
...
Ce chapitre a précisé les besoins fonctionnels et non fonctionnels du système, les profils utilisateurs et le périmètre retenu, puis justifié l'ensemble des choix technologiques qui structurent la plateforme, en privilégiant la cohérence de l'ensemble et la simplicité d'exploitation. Ces choix forment le socle sur lequel repose la conception détaillée du système, présentée au chapitre suivant.
