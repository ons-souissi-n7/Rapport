...
La lecture du diagramme fait ressortir la répartition des responsabilités. L'étudiant n'accède qu'à des cas de consultation et de déclaration relatifs à sa propre mobilité : catalogue de destinations, recommandations, vœux, résultat d'affectation, mobilité complémentaire et suivi de sa durée de mobilité. L'administrateur RI concentre le pilotage : cycle de vie des années universitaires, référentiels, accords et quotas, synchronisation et réconciliation des imports, lancement et supervision de l'algorithme d'affectation, instruction des mobilités, finalisation CTI et consultation du journal d'audit. Le CAS et les systèmes sources n'interviennent qu'en appui, respectivement pour l'authentification et pour l'alimentation des imports.
