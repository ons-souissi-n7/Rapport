...
Les accords bilatéraux fixent un nombre total de places disponibles pour
l'ENSEEIHT. Ces places doivent ensuite être réparties entre les trois
départements pédagogiques (SN, 3EA, MF2E) en tenant compte de leur taille
respective. La méthode retenue doit être simple à comprendre, transparente
et reproductible, car elle conditionne directement les chances de départ
de chaque étudiant.
...
\textit{Limites :}
\begin{itemize}
  \item Tend à favoriser les départements les plus grands au détriment
        des petits
...
Ce chapitre a présenté les choix technologiques qui structurent la plateforme. Chaque composant a été sélectionné en fonction des besoins concrets du projet, en privilégiant la cohérence de l'ensemble et la simplicité d'exploitation. Ces technologies constituent le socle technique sur lequel repose le développement présenté dans les chapitres suivants.
